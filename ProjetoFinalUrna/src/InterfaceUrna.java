...
public class InterfaceUrna extends javax.swing.JFrame implements Interface{
    ...
    public void setVotacao(){
        switch(txtNum.getText()){
            ...
            case "00" -> {
                addCandidato(votoNulo);
                votoNulo.setVotos();
                JOptionPane.showMessageDialog(rootPane, "Voto computado!");
            }
            case "Branco" -> {
                addCandidato(votoBranco);
                votoBranco.setVotos();
                JOptionPane.showMessageDialog(rootPane, "Voto computado!");
            }
            default -> {
    ...
    @Override
        ...
        if(votosComputados.isEmpty()){
            ...
            vot += c13.getNome()+" possui: "+c13.getVotos()+" votos válidos!\n";
            vot += c22.getNome()+" possui: "+c22.getVotos()+" votos válidos!\n";
            vot += c12.getNome()+" possui: "+c12.getVotos()+" votos válidos!\n";
            vot += c15.getNome()+" possui: "+c15.getVotos()+" votos válidos!\n";
            vot += "Voto em "+votoBranco.getNome()+" possui: "+votoBranco.getVotos()+" votos válidos!\n";
            vot += "Voto em "+votoNulo.getNome()+" possui: "+votoNulo.getVotos()+" votos válidos!";
            JOptionPane.showMessageDialog(null, vot);
        }
    }
    ...
    private void initComponents() {
        ...
        lblImg.setIcon(new javax.swing.ImageIcon("C:\\Users\\David\\Documents\\NetBeansProjects\\ProjetoFinalUrna\\src\\imagens\\justiçaeleitoral.jpg")); // NOI18N

        btnInfo.setIcon(new javax.swing.ImageIcon("C:\\Users\\David\\Documents\\NetBeansProjects\\ProjetoFinalUrna\\src\\imagens\\info.jpg")); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\David\\Documents\\NetBeansProjects\\ProjetoFinalUrna\\src\\imagens\\duvida.jpg")); // NOI18N
